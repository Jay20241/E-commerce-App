...
import 'package:multistoreapp/views/screens/register.dart';
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: isLoading? LinearGradient(colors: [const Color.fromARGB(255, 249, 250, 249), const Color.fromARGB(255, 245, 248, 245)]) : LinearGradient(colors: [const Color.fromARGB(255, 37, 108, 39), const Color.fromARGB(255, 4, 68, 6)])
                        ),
                        child: Stack(
                          children: [
                            Positioned(
                              ...
                              Center(child: isLoading? const CircularProgressIndicator(color: Colors.grey):Text('Sign in', style: GoogleFonts.getFont('Lato', color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)))
                          ],
                        ),
                      ),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Text("Sign Up", style: GoogleFonts.roboto(color: Colors.deepPurple, fontWeight: FontWeight.bold, letterSpacing: 1)))
                      ],
                    )
