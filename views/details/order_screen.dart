...
import 'package:multistoreapp/provider/order_provider.dart';
import 'package:multistoreapp/provider/user_provider.dart';
import 'package:multistoreapp/views/details/order_details_screen.dart';
            ...
            Positioned(
              ...
              child: Stack(
                children: [
                  ...
                  child: Center(child: Text(orders.length.toString() , style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 11),),),))
                ],
              )),
                          ...
                          children: [
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: Text(order.productPrice.toString())),
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                clipBehavior: Clip.antiAlias,
                                decoration: BoxDecoration(
                                  color: order.delivered==true ? Colors.teal : order.processing==true ? Colors.purple : Colors.red,
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    Positioned(
                                      left: 9,
                                      top: 2,
                                      child: Text(order.delivered==true ? "Delivered" : order.processing==true ? "Processing" : "Canceled")
                                      ),
