...
import 'package:multistoreapp/views/details/order_screen.dart';
import 'package:multistoreapp/views/screens/shipping_address_screen.dart';


class AccountSceen extends ConsumerStatefulWidget {
...
class _AccountSceenState extends ConsumerState<AccountSceen> {
  ...
  Widget build(BuildContext context) {  
    ...
    ref.read(orderCountProvider.notifier).fetchDeliveredOrderCount(buyerId, context);
    final deliveredCount = ref.watch(orderCountProvider);
